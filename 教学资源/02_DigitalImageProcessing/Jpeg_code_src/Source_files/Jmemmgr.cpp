...
#include "..\Header_files\jinclude.h"
#include "..\Header_files\jpeglib.h"
#include "..\Header_files\jmemsys.h"		/* import the system-dependent declarations */
...
/* Allocate a "small" object */
{
  ...
  if (hdr_ptr == NULL) {
    ...
    mem->total_space_allocated += long( min_request + slop ); // modified by Xinghua
...
/* Allocate a "large" object */
{
  ...
  mem->total_space_allocated += long( sizeofobject + SIZEOF(large_pool_hdr) ); // modified by Xinghua
...
free_pool (j_common_ptr cinfo, int pool_id)
{
  ...
  while (lhdr_ptr != NULL) {
    ...
    mem->total_space_allocated -= long( space_freed ); // modified by Xinghua
